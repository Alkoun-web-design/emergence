        ...
        <>
            <div className="grid grid-cols-subgrid justify-items-center col-start-2 col-end-12 ">
                ...
                <motion.div
                    ...
                    className="col-span-full pb-80 text-center">
                    ...
                    <button className="px-8 py-4 border border-[#C1CAA0] bg-[#C1CAA0] text-gray-50 mx-4 rounded-lg mt-8 hover:bg-gray-50 hover:text-[#C1CAA0] hover:-translate-y-1 hover:cursor-pointer hover:shadow-lg transition-all duration-300">Explore Modules</button>
