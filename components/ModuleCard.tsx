export default function ModuleCard({ image, title, description, href }: {image:string; title: string; description: string; href: string;}) {
  return (
    <div className="col-span-4 p-4 border-2 border-gray-900 rounded-md backdrop-blur-2xl">
        ...
        <div className="my-2">
            <button className="py-2 px-4 rounded-lg bg-lime-800 hover:cursor-pointer">Enroll Now</button>
        </div>
    </div>
  )
}