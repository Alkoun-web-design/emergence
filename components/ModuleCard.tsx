export default function ModuleCard({ image, name, description, price, discount, discountPrice, slug }: {image:string; name: string; description: string; price: string, discount: boolean, discountPrice: string, slug: string;}) {
  return (
    ...
    <div className="col-span-4 w-full mx-1 rounded-md backdrop-blur-2xl bg-gray-100 shadow-gray-900/30 border border-[#C1CAA0] mb-8 hover:shadow-lg hover:-translate-y-1.5 duration-500 transition-all">
        <div className="mb-2">
